...
public class HardwareAccess {
     ...
     * You will be notified by calling {@link com.fireballlabs.impl.HardwareAccess.HardwareAccessCallbacks#accessCompleted(int, boolean) after trying to get access}
     * @param context Context to be used for enabling the feature
     * @param callback Callback whose {@link com.fireballlabs.impl.HardwareAccess.HardwareAccessCallbacks#accessCompleted} will be called
