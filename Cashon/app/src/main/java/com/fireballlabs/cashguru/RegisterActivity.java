...
import com.fireballlabs.helper.PreferenceManager;
import com.fireballlabs.helper.model.Referrals;
import com.fireballlabs.helper.model.UserHelper;
import com.fireballlabs.impl.SimpleAsyncTask;
...
public class RegisterActivity extends Activity {
    ...
    static final String BROADCAST_RECEIVER_ACTION = "com.fireballlabs.cashguru.receiver";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.country_codes, R.layout.simple_spinner_item);
