...
public class Offer {
    ...
    public void saveData(Context context) {
        ...
        if(db != null) {
            ...
            values.put(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS_COLUMN_AFFID, id);
            values.put(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS_COLUMN_IMAGE, imageName);
            values.put(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS_COLUMN_PACKAGE_NAME, packageName);
            values.put(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS_COLUMN_AFFLINK, affLink);
            values.put(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS_COLUMN_TITLE, title);
            values.put(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS_COLUMN_SUB_TITLE, subTitle);
            values.put(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS_COLUMN_DESCRIPTION, description);
            values.put(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS_COLUMN_PAYOUT, payout);
            values.put(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS_COLUMN_TYPE, type);
            long id1 = db.insert(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS, null, values);
            if(id1 == -1) {
                ...
                for (Payout payout :
                    ...
                    values2.put(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_PAYOUT_COLUMN_OFFER_AFFID, id);
                    values2.put(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_PAYOUT_COLUMN_PAYOUT, payout.payout);
                    values2.put(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_PAYOUT_COLUMN_PAYOUT_TYPE, payout.offerType);
                    values2.put(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_PAYOUT_COLUMN_PAYOUT_DESCRIPTION, payout.description);
                    long id2 = db.insert(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_PAYOUT, null, values2);
                    if(id2 == -1) {
                        // TODO do Parse error reporting
                        Logger.doSecureLogging(Log.WARN, AppInstallsFragment.class.getName()
    ...
    public static List<Offer> getData(Context context) {
        ...
        if(db != null) {
            Cursor cursor = db.query(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS, null, null, null, null, null, null);
            if(cursor == null || cursor.getCount() == 0) {
                ...
                while(!cursor.isAfterLast()) {
                    Offer offer = new Offer();
                    offer.id = cursor.getString(cursor.getColumnIndex(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS_COLUMN_AFFID));
                    offer.imageName = cursor.getString(cursor.getColumnIndex(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS_COLUMN_IMAGE));
                    offer.packageName = cursor.getString(cursor.getColumnIndex(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS_COLUMN_PACKAGE_NAME));
                    offer.affLink = cursor.getString(cursor.getColumnIndex(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS_COLUMN_AFFLINK));
                    offer.title = cursor.getString(cursor.getColumnIndex(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS_COLUMN_TITLE));
                    offer.subTitle = cursor.getString(cursor.getColumnIndex(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS_COLUMN_SUB_TITLE));
                    offer.description = cursor.getString(cursor.getColumnIndex(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS_COLUMN_DESCRIPTION));
                    offer.payout = cursor.getInt(cursor.getColumnIndex(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS_COLUMN_PAYOUT));
                    offer.type = cursor.getInt(cursor.getColumnIndex(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS_COLUMN_TYPE));

                    int dbId = cursor.getInt(cursor.getColumnIndex(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS_COLUMN_AFFID));
                    String whereClause = CashOnSqliteOpenHelper.TABLE_APP_INSTALL_PAYOUT_COLUMN_OFFER_AFFID + " = ?";
                    String[] whereArgs = new String[] {
                            String.valueOf(offer.id)
                    };
                    Cursor cursor2 = db.query(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_PAYOUT, null, whereClause, whereArgs, null, null, null);
                    if(cursor2 == null || cursor2.getCount() == 0) {
                        ...
                        while(!cursor2.isAfterLast()) {
                            ...
                            payout.payout = cursor2.getInt(cursor2.getColumnIndex(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_PAYOUT_COLUMN_PAYOUT));
                            payout.offerType = cursor2.getInt(cursor2.getColumnIndex(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_PAYOUT_COLUMN_PAYOUT_TYPE));
                            payout.description = cursor2.getString(cursor2.getColumnIndex(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_PAYOUT_COLUMN_PAYOUT_DESCRIPTION));
    ...
    public static float checkIfOffer(Context context, String packageName) {
        ...
        String whereClause = CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS_COLUMN_PACKAGE_NAME + "=?";
        String[] whereArgs = new String[]{packageName};
        Cursor cursor = database.query(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS,
                new String[]{CashOnSqliteOpenHelper.TABLE_APP_INSTALL_OFFERS_COLUMN_AFFID}, whereClause, whereArgs, null, null, null);
        if(cursor == null || cursor.getCount() == 0) {
            if(cursor != null) {
                cursor.close();
            }
            ...
            cursor.close();
            whereClause = CashOnSqliteOpenHelper.TABLE_APP_INSTALL_PAYOUT_COLUMN_OFFER_AFFID + "=?";
            whereArgs = new String[]{affId};
            cursor = database.query(CashOnSqliteOpenHelper.TABLE_APP_INSTALL_PAYOUT,
                    new String[]{CashOnSqliteOpenHelper.TABLE_APP_INSTALL_PAYOUT_COLUMN_PAYOUT}, whereClause, whereArgs, null, null, null);
            if(cursor == null || cursor.getCount() == 0) {
                if (cursor != null) {
                    cursor.close();
                }
