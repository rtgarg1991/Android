...
import com.cashon.view.SlidingTabLayout;
...
public class SlidingTabFragment extends Fragment {
    ...
    public static SlidingTabFragment newInstance(String[] titles, int[] fragmentIds) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < titles.length; i++) {
            mTabs.add(new PagerItem(titles[i], fragmentIds[i]));
        }
    }
...
//                return mTabs.get(position).getDividerColor();
    ...
    static class PagerItem {
        ...
        PagerItem(String title, int fragmentId) {
            mTitle = title;
