 ...
 */
public class CashOnSqliteOpenHelper extends SQLiteOpenHelper {
    ...
    public CashOnSqliteOpenHelper(Context context) {
        super(context, DATABASE_NAME, null, DATABASE_VERSION);
    }
    @Override
    public void onCreate(SQLiteDatabase db) {
        Logger.doSecureLogging(Log.DEBUG, CashOnSqliteOpenHelper.class.getName() + " Database onCreate");
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        Logger.doSecureLogging(Log.DEBUG, CashOnSqliteOpenHelper.class.getName()
