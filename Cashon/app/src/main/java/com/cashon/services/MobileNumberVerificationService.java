...
public class MobileNumberVerificationService extends Service implements SimpleDelayHandler.SimpleDelayHandlerCallback {
    ...
    public static final String ACTION_MOBILE_NUMBER_VERIFICATION = "com.cashon.services.action.mobile.verification";
    public static final String EXTRA_PARAM_MOBILE_NUMBER = "com.cashon.services.extra.mobile";
    public static final String EXTRA_PARAM_RECEIVER = "com.cashon.services.action.receiver";
    public static final String EXTRA_PARAM_RECEIVER_RESULT = "com.cashon.services.extra.mobile";
