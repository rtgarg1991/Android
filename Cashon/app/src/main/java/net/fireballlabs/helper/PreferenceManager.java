...
public class PreferenceManager {
    ...
    public static SharedPreferences getSharedPreferences(Context context, int mode)
        ...
        return context.getSharedPreferences(Constants.CASHGURU_SHARED_PREF, mode);
    }
     ...
     * @throws IllegalArgumentException If context provided is null or key provided is empty or null
     */
    public static Float getDefaultSharedPreferenceValue(
            Context context, String key, int mode, Float defaultValue)
            throws IllegalArgumentException{
        if(key == null || TextUtils.isEmpty(key)) {
            throw new IllegalArgumentException(Constants.EXCEPTION_INVALID_KEY);
        }
        ...
        return getSharedPreferences(context, mode).getFloat(key, defaultValue);
    }
     ...
     * @param mode Mode to be used for getting SharedPreferences
     * @param defaultValue Default value, if Key not found then this will be returned
     * @return Integer value for the key in SharedPreferences
     * @throws IllegalArgumentException If context provided is null or key provided is empty or null
     */
    public static int getDefaultSharedPreferenceValue(
            Context context, String key, int mode, int defaultValue)
            throws IllegalArgumentException{
        if(key == null || TextUtils.isEmpty(key)) {
            throw new IllegalArgumentException(Constants.EXCEPTION_INVALID_KEY);
        }
        ...
        return getSharedPreferences(context, mode).getInt(key, defaultValue);
    }
     ...
     */
    public static void setDefaultSharedPreferenceValue(
            Context context, String key, int mode, Float value)
            throws IllegalArgumentException{
        if(key == null || TextUtils.isEmpty(key)) {
            throw new IllegalArgumentException(Constants.EXCEPTION_INVALID_KEY);
        }
     ...
     */
    public static void setDefaultSharedPreferenceValue(
            Context context, String key, int mode, int value)
            throws IllegalArgumentException {
        if(key == null || TextUtils.isEmpty(key)) {
            throw new IllegalArgumentException(Constants.EXCEPTION_INVALID_KEY);
        }
