...
public class LatestDeal {
    ...
    private static final String PARSE_TABLE_LATEST_DEALS_COLUMN_TYPE = "type";

    public static final int TYPE_ONLINE_DEAL = 1;
    public static final int TYPE_REFER_CODE_DEAL = 2;
    ...
    public static List<LatestDeal> getAllDeals() throws ParseException {
        ...
        for(ParseObject obj : list) {
            ...
            deal.setType(obj.getInt(PARSE_TABLE_LATEST_DEALS_COLUMN_TYPE));
